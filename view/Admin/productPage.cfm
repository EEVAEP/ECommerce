...
<cftry>
     <cfset local.decryptedSubCategoryId = application.modelAdminCtg.decryptId(url.subCategoryId)>
    <cfset productListQuery = application.modelAdminCtg.getProductsList(local.decryptedSubCategoryId)>
    <cfcatch>
        <cfdump  var="#cfcatch#">
    </cfcatch>
</cftry>
